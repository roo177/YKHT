    ...
    (
        (
            (
                t_Aylik_Say_EndPer 
                LEFT JOIN 
                k_Rayicler_L3 ON t_Aylik_Say_EndPer.L3_R_Kod = k_Rayicler_L3.L3_R_Kod
            ) 
            LEFT JOIN 
            q_Gnc_Art_Kts 
            ON 
        ...
        LEFT JOIN 
        q_Kabuller_R3 ON t_Aylik_Say_EndPer.L3_R_Kod = q_Kabuller_R3.L3_R_Kod
    )
    LEFT JOIN q_Personel ON t_Aylik_Say_EndPer.L3_R_Kod = q_Personel.p_Kod
