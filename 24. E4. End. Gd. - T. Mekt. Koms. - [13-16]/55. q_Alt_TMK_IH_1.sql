...
SELECT 
    ...
    Sum( Round(  ( 
                IIf( IsNull( i_2023_10 ), 0, i_2023_10 )
            )   * end_Yuzde 
        , 2 )
    ) 
    AS tm_Tutar
...
WHERE
    end_Dagilim = "E-7.FIN-01.TEM-020" AND
    end_Ay >= #10/1/2023# 
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2024_01 ), 0, i_2024_01 )
            )   * 0.05 * end_Yuzde
        ,2 )
    ) 
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2024_04 ), 0, i_2024_04 ) 
            )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2024_07 ), 0, i_2024_07 ) 
            )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2025_01 ), 0, i_2025_01 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2025_04 ), 0, i_2025_04 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2025_07 ), 0, i_2025_07 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2026_01 ), 0, i_2026_01 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2026_04 ), 0, i_2026_04 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2026_07 ), 0, i_2026_07 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2027_01 ), 0, i_2027_01 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2027_04 ), 0, i_2027_04 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2027_07 ), 0, i_2027_07 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                IIf( IsNull( i_2027_11 ), 0, i_2027_11 ) +
                IIf( IsNull( i_2027_12 ), 0, i_2027_12 ) +
                IIf( IsNull( i_2028_01 ), 0, i_2028_01 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2028_04 ), 0, i_2028_04 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
...
SELECT 
    ...
    Sum( Round(  (
                ...
                IIf( IsNull( i_2028_07 ), 0, i_2028_07 )
                )   * 0.05 * end_Yuzde
        ,2 )
    )
    AS tm_Tutar
